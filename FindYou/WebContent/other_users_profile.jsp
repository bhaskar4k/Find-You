...
<html>
	<head>
	    ...
	    <link rel="stylesheet" href="CSS/style_other_users_profile.css">
		...
		String session_profile_photo = (String) request.getAttribute("session_profile_photo");
		User userInfo = (User) request.getAttribute("userInfo");		
		
		ArrayList<ArrayList<String>> allFollowerList = (ArrayList<ArrayList<String>>) request.getAttribute("allFollowerList");
		ArrayList<ArrayList<String>> allFollowingList = (ArrayList<ArrayList<String>>) request.getAttribute("allFollowingList");
		...
		<div class="profile_header" id="profile_header">
			<div class="all_heading">
				...
				<div style="position: relative; overflow: hidden; width: 45px; height: 45px; margin-top: 6px; margin-right: 6px; cursor: pointer;" onclick="profile_controller();">
					<img src="./DB_image/<%=session_profile_photo%>" alt="Profile Photo" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%; border: 2px solid #03adfc;">
			...
			<div class="right">
				<div class="user_info">
					<div class="follow">
						...
						<div style="padding-left: 140px; cursor: pointer;" onclick="do_follow();">
							<div id="is_followed"></div>
						</div>
					</div>
			...
			<script>
				...
				function do_follow(){
					$(document).ready(function(){
						$.ajax({
							type: 'POST',
							data: {command: "DO_FOLLOW", userid: "<%=userid%>"},
							url: 'Profile',
							success: function(){
								is_followed();
							}
				...
				function is_followed(){
					$(document).ready(function(){
						$.ajax({
							type: 'POST',
							data: {command: "IS_FOLLOWED", userid: "<%=userid%>"},
							url: 'Profile',
							success: function(result){
								$('#is_followed').html(result);
							}
						});
					});
				}
